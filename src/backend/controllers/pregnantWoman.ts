...
async function updatePregnantWomanData(req,field, model){
    ...
    export async function updateBiodata(req, res){
        const user:any = await User.findById(req.user._id);
